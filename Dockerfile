...
RUN apt-get install android-tools-adb android-tools-fastboot  postgresql-client -y
RUN apt install aapt wget unzip sudo -y
RUN wget https://h-mdm.com/files/hmdm-5.09-install-ubuntu.zip
RUN unzip hmdm-5.09-install-ubuntu.zip
